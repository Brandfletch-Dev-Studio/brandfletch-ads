...
export default function BlogPost() {
  ...
  useSEO(post ? {
    ...
    jsonLd: {
      ...
      dateModified: post.updated_date || post.published_at || undefined,
      author: { '@type': 'Person', name: post.author_name || 'Brandfletch Team' },
      publisher: {
        '@type': 'Organization',
        name: 'Brandfletch Media',
        logo: { '@type': 'ImageObject', url: 'https://brandfletch.com/favicon.png' },
      },
      mainEntityOfPage: { '@type': 'WebPage', '@id': `https://brandfletch.com/blog/${post.slug}` },
