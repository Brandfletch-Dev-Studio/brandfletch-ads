...
Deno.serve(async (req) => {
  try {
    ...
    const { campaign_id, event_type, notes } = body;
    ...
    // Fetch campaign and user info using service role
    const campaign = await base44.asServiceRole.entities.Campaign.filter({ id: campaign_id }).then(r => r[0]);
